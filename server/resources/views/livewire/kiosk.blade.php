<div>
    ...
    <div class="field">
        <label class="label" for="addProductId">@lang('kiosk.products')</label>
        <div class="control">
            <form wire:submit.prevent="addProduct">
                <div class="field has-addons">
                    <div class="control" style="width: 100%;">
                        <div class="select is-fullwidth">
                            <select id="addProductId" wire:model.defer="addProductId">
                                <option value="null" disabled selected>@lang('kiosk.select_product')</option>
                    ...
                    <div class="control">
                        <button class="button is-link" type="submit">@lang('kiosk.add_product')</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="media" style="display: flex; align-items: center;">
                ...
                <div class="media-content">
                    <label class="label" for="amount{{ $index }}">
                        {{ $transactionProduct['product']['name'] }} (&euro; {{ $transactionProduct['product']['price'] }}) @lang('kiosk.amount'):
    ...
    <div class="field">
        <div class="control">
            <button type="submit" form="createTransaction" class="button is-link">@lang('kiosk.create_transaction')</button>
        </div>
    </div>
</div>

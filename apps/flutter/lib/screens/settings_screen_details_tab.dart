...
class _SettingsChangeDetailsTabState extends State {
  ...
  changeDetails() async {
    ...
    if (errors != null) {
      setState(() {
        _firstnameError =
            errors.containsKey('firstname') ? errors['firstname']![0]! : null;
        _insertionError =
            errors.containsKey('insertion') ? errors['insertion']![0]! : null;
        _lastnameError =
            errors.containsKey('lastname') ? errors['lastname']![0]! : null;

        _emailError = errors.containsKey('email') ? errors['email']![0]! : null;
        _phoneError = errors.containsKey('phone') ? errors['phone']![0]! : null;

        _addressError =
            errors.containsKey('address') ? errors['address']![0]! : null;
        _postcodeError =
            errors.containsKey('postcode') ? errors['postcode']![0]! : null;
                ...
                child: Padding(
                    ...
                    child: Column(children: [
                      Container(
                        ...
                        child: Text(lang.settings_details_header,
                      ...
                      Container(
                        width: double.infinity,
                        margin: const EdgeInsets.only(bottom: 16),
                        child: Text(lang.settings_details_personal_info,
                            style: const TextStyle(
                                fontSize: 16,
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                          ...
                                          child: ListView(
                                              ...
                                              children: [
                                                ...
                                                ListTile(
                                                    ...
                                                    title: Text(lang
                                                        .settings_details_gender_female),
                                                    onTap: () {
                                                      setGender(
                                                          gender:
                                                              Gender.female);
                                      ...
                                      actions: [
                                        TextButton(
                                            child: Text(lang
                                                .settings_details_gender_cancel),
                                            onPressed: () =>
                      ...
                      InputField(
                          ...
                          onTap: !user.minor!
                              ? () async {
                                  ...
                                  setState(() => _birthdayController.text =
                                      _birthday != null
                      ...
                      if (user.minor!) ...[
                        Container(
                          width: double.infinity,
                          margin: const EdgeInsets.only(bottom: 16),
                          child: Text(lang.settings_details_birthday_minor,
                              style:
                      ...
                      Container(
                        ...
                        child: Text(lang.settings_details_contact_info,
                            style: const TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w500,
                                color: Colors.grey)),
                      ...
                      Container(
                        width: double.infinity,
                        margin: const EdgeInsets.only(top: 8, bottom: 16),
                        child: Text(lang.settings_details_address_info,
                            style: const TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.w500,
                                color: Colors.grey)),
                      ...
                      Container(
                        width: double.infinity,
                        margin: const EdgeInsets.only(top: 8, bottom: 16),
                        child: Text(lang.settings_details_email_notifications,
                            style: const TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.w500,
                                color: Colors.grey)),
                      ...
                      Container(
                          margin: const EdgeInsets.only(bottom: 16),
                          child: Row(children: [
                            Text(lang.settings_details_receive_news,
